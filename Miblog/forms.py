...
# class FormLogin(forms.ModelsForm):
#   user = forms.CharField(widget=forms.textInput(attrs={'title': 'Su Nombre'}))
#   pw = forms.CharField(widget=forms.passwordInput(render_value=False))
